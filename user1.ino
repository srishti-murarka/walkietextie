...
void setup()
{
  //---------SerialSetup---------
  Serial.begin(9600);
  Serial.println("::Srishti's Window::");
  //---------SerialSetup---------

  //---------RFSetup---------
  radio.begin();
  radio.setDataRate( RF24_250KBPS );
  radio.openWritingPipe(ipsitaAddr); // NB these are swapped compared to the master
  radio.openReadingPipe(1, srishtiAddr);
